...
Be sure to update the "DIR" arg on line 5 of the Dockerfile to be the same as the example name. In this case, it is `nucleotide-count`.

```
docker build --rm -f "Dockerfile" -t exercism-cpp-nucleotide-count:test-1 .
```
